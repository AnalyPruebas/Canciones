...
export class CancionService {
  ...
  eliminar(idCancion: number): Promise<CancionEntity> {
    const cancionAEliminar: CancionEntity = this._cancionRepository.create({
      id: idCancion,
    });
